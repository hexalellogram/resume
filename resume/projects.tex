...
%---------------------------------------------------------
  \cvproject
  {\href{https://elated-pike-6f8e56.netlify.app/}{ACM Profiles: \normalfont{Social media aggregation and sharing platform}}} % Project Name + Link
  {Oct. 2020 - Jan. 2020} % Dates
  {
...
%---------------------------------------------------------
  \cvproject
    {\href{https://github.com/hexalellogram/SafariSideloader}{SafariSideloader: \normalfont{Script to convert WebExtensions into Safari 14.0+ compatible format}}} % Project Name + Link
    {Jun. 2020} % Dates
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
